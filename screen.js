// Author: Samuel Lewis
// Date: 8/3/2018
// This program will now be called after the csv file is parsed and usable
// It controls the API calls and make sure that all of the stock tickers are screened

module.exports = {
    screen: function(inputArray){
        ...
        // ***** For testing purposes, for(i=0;i<array.length;i++){ will be changed to for(i=0;i<50;i++){
        // Running this test should take 10 minutes to complete
        for(i=0;i<50;i++){
